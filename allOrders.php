                  ...
                  ?>
                    <li class="nav-item dropdown">
                      ...
                      <ul class="dropdown-menu" aria-labelledby="dropdown06">
                        ...
                        <li><a class="dropdown-item active" href="allOrders.php"><i class="fas fa-clipboard-list">&nbsp;All orders</i></a></li><hr>
    ...
    for($i=0;$i<80;$i++)
        {
            ...
            <td>Med Id</td>
            <td>Quantity</td>
            <td class="p-0"><button class="btn btn-danger m-0 py-2" onclick="hello()" style="width:100%">Cancel Order</button></td>
            </tr>
<?php
        }
        ?>
